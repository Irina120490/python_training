...
class Contacts(unittest.TestCase):
    ...
    def test_contacts_two(self):
        ...
        self.add_new_contact(wd, Contactsgroup (firstname="Anna", middlename="Morozova", nickname="Ann",
    ...
    def test_contacts(self):
        ...
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.add_new_contact(wd, Contactsgroup (firstname="Jonn", middlename="Smith", nickname="Jo", company="Google",
