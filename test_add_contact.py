# -*- coding: utf-8 -*-
import pytest
from applicationcontact import ApplicationContact
...
def test_add_contact_two(app):
    ...
    app.add_new_contact(Contact(firstname="Anna", middlename="Morozova", nickname="Ann",
...
def test_add_contact(app):
    app.login(username="admin", password="secret")
    app.add_new_contact(Contact(firstname="Jonn", middlename="Smith", nickname="Jo", company="Google",
